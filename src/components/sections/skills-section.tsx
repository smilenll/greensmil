...
const frontendTechnologies = [
  ...
  { name: 'React Native', logo: '/technologies/react.svg', website: 'https://reactnative.dev/' },
  { name: 'Expo', logo: '/technologies/expo.svg', website: 'https://expo.dev/' },
  { name: 'TanStack', logo: '/technologies/tanstack.svg', website: 'https://tanstack.com/' },
  { name: 'Angular', logo: '/technologies/angular.svg', website: 'https://angular.dev/' },
  { name: 'Enzyme', logo: '/technologies/enzyme.svg', website: 'https://enzymejs.github.io/enzyme/' },
...
const backendTechnologies = [
  ...
  { name: 'Hono', logo: '/technologies/hono.svg', website: 'https://hono.dev/' },
  { name: 'Fastify', logo: '/technologies/fastify.svg', website: 'https://fastify.dev/' },
...
const toolsTechnologies = [
  ...
  { name: 'Keycloak', logo: '/technologies/keycloak.svg', website: 'https://www.keycloak.org/' },
  { name: 'Zitadel', logo: '/technologies/zitadel.svg', website: 'https://zitadel.com/' },
  { name: 'AJV', logo: '/technologies/ajv.svg', website: 'https://ajv.js.org/' },
